    ...
    <div className="home-container">
      <div className="hero-section">
        ...
        <div className="hero-content">
          ...
          <p className="subtitle">
            Your personal roadmap to success. Plan your goals, set your
            schedule, and achieve your dreams with our intuitive planning tool.
          </p>
        ...
        <div className="hero-graphic">
          ...
          >
            ...
            {/* Goal Path */}
            <path
              d="M100 200 C 150 100, 350 100, 400 200"
              stroke="#FFFFFF"
              strokeWidth="4"
              strokeDasharray="8 8"
            />
      ...
      <div className="features-section">
        <div className="feature-card">
          ...
          <p>
            Use our intuitive goal maker to define what you want to achieve.
            Break down big dreams into manageable tasks.
          </p>
        </div>
        ...
        <div className="feature-card">
          ...
          <p>
            Tell us about your daily routine, preferred working hours, and meal
            times to create a schedule that works for you.
          </p>
        </div>
        ...
        <div className="feature-card">
          ...
          <p>
            Monitor your achievements and stay motivated as you work towards
            your goals.
          </p>
        </div>
      </div>
